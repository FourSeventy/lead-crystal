...
public class CursorFactory 
{
    ...
    public Cursor getCursor(CursorType type)
    {
        ...
        switch(type)
        {
            ...
            case ACTIVEHAND: cursor = new Cursor(new Image("reticle08.png"){{ setDimensions(39,39);}}, Anchorable.Anchor.TOPCENTER); break;
            case UNACTIVEHAND: cursor = new Cursor(new Image("reticle10.png"){{ setDimensions(39,39);}}, Anchorable.Anchor.TOPCENTER);  break;
            case POINTERHAND: cursor = new Cursor(new Image("reticle07.png"){{ setDimensions(39,39);}}, Anchorable.Anchor.TOPLEFT); break;
            case PURCHASEHAND: cursor = new Cursor(new Image("reticle09.png"){{ setDimensions(39,39);}}, Anchorable.Anchor.TOPCENTER); break;
            default: cursor = null;
        }
