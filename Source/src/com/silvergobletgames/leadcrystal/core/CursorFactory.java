...
public class CursorFactory 
{
    ...
    public Cursor getCursor(CursorType type)
    {
        ...
        switch(type)
        {
            ...
            case WRENCH:cursor = new Cursor(new Image("reticle07.png"){{ setDimensions(39,39);}}, Anchorable.Anchor.CENTER);  break;
            ...
            case HAND: cursor = new Cursor(new Image("reticle07.png"){{ setDimensions(39,39);}}, Anchorable.Anchor.CENTER); break;
