 ...
 */
public class BrainHealer extends BrainGround
{
    ...
    {
        super();
        relevantGroups.add(ExtendedSceneObjectGroups.HEALER);
        ID = BrainID.Healer;
    }
...
//        } 
    ...
    {        
        ...
        //get all healing skills
        ArrayList<Skill> skillPool = self.getSkillManager().getKnownSkillsOfType(SkillType.HEAL);
...
//        }
    ...
    public void targetClosestDamagedFriendly()
    {
        
        float closestDistance = Float.MAX_VALUE;
        NonPlayerEntity closestFriendly = null;
        
        ArrayList<SceneObject> fighters = self.getOwningScene().getSceneObjectManager().get(ExtendedSceneObjectGroups.FIGHTER);
