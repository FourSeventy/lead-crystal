 ...
 * @author mike
 */
public class EnemyFlierGooTriBomb extends Skill 
{
    
    public EnemyFlierGooTriBomb()
    {
        super(SkillID.EnemyFlierGooTriBomb,SkillType.OFFENSIVE,ExtendedImageAnimations.RANGEDATTACK,200,800);
    }
    ...
    {       
        ...
        body = new Body(new Circle(24), 1);
        img = new Image("poison_goo_dart.png");
        img.setDimensions(50, 50);
        img.setColor(new Color(1f,1.2f,1f,1f));
        GooBombHitBox goo2 = new GooBombHitBox(damage, body, img, user);
        
        body = new Body(new Circle(24), 1);
        img = new Image("poison_goo_dart.png");
        img.setDimensions(50, 50);
        img.setColor(new Color(1f,1.2f,1f,1f));
        GooBombHitBox goo3 = new GooBombHitBox(damage, body, img, user);
        ...
        float xforce2 = 900*upVector.x;
        float yforce2 = 900*upVector.y;
        
        float xforce3 = 900*downVector.x;
        float yforce3 = 900*downVector.y;
        ...
        emitter2.setAngle((float)(theta * 180f/Math.PI));
        ...
        emitter3.setAngle((float)(theta * 180f/Math.PI));
