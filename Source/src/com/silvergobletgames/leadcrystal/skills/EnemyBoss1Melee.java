...
public class EnemyBoss1Melee extends Skill{
    
    public EnemyBoss1Melee()
    {
        super(SkillID.EnemyBoss1Melee,Skill.SkillType.OFFENSIVE, ExtendedImageAnimations.MELEEATTACK,180,400);
