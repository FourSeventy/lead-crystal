 ...
 * @author Mike
 */
public class EnemySmallAntThrow extends Skill {
    
    
    public EnemySmallAntThrow()
    {
        super(SkillID.EnemySmallAntThrow,SkillType.OFFENSIVE,ExtendedImageAnimations.MELEEATTACK,360,1100);
